...
O AEM Guides tem recursos de publicação incorporados para gerar saídas em uma variedade de formatos padrão do setor. A versão atual do AEM Guides permite gerar saída nos formatos mais usados: AEM Site, PDF, HTML5, EPUB, JSON e saída personalizada por meio de DITA-OT, publicação nativa do PDF e FMPS.
