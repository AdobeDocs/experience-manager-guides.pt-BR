...
user-guide-description: Leia a documentação do produto Adobe Experience Manager Guides usando a interface antiga.
...
- [Informações da versão](https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/release-info/aem-guides-releases-roadmap){target="_blank"}
