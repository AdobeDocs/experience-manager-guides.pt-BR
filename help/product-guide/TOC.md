...
+ Informações da versão {#release-info}
   ...
   + Notas de versão {#release-notes}
      ...
      + Versão 4.4.0 {#44-release}
         + Novidades {#44-whats-new}
            + [4.4 Novidades](./release-info/whats-new-4.4.md)
         + Notas de versão {#44-release-notes}
            + [Notas de versão 4.4](./release-info/release-notes-4.4.md)
...
+ Guia do usuário {#user-guide}
   + Introdução {#about-aem-guide}
      ...
      + [!DNL AEM Guides] funcionamento e principais recursos {#aemg-works-features}
         + [Como [!DNL AEM Guides] funciona](./user-guide/intro-how-dxml-works.md)
         + [Chave [!DNL AEM Guides] recursos](./user-guide/intro-dxml-features.md)
   ...
   + Conteúdo do autor {#author-content}
      ...
      + Criação e visualização do tópico {#create-preview-topics}
         ...
         + Conteúdo do autor {#author-content-aem-guides}
            + [Maneira de criar conteúdo usando guias do AEM](./user-guide/authoring-content-xml-doc.md)
   ...
   + Metadados em guias AEM {#manaege-metadata}
   ...
   + Geração de saída {#output-gen}
      ...
      + Predefinições de saída em guias AEM {#output-presets-aemg}
   ...
   + Relatórios nos Guias do AEM {#reports-aem-guide}
...
+ Instalação e configuração {#install-guide}
   + No local {#on-prem-ig}
      ...
      + Baixar, instalar e atualizar {#download-install-upgrade-aemg}
         ...
         + [Baixe e instale os Guias do AEM pela primeira vez](./install-guide/download-install-aemg-first-time.md)
         + [Configurar o Dispatcher](./install-guide/download-install-configure-dispatcher.md)
         + [Verificar a instalação dos Guias do AEM](./install-guide/download-install-verify-aemg-installation.md)
         + [Atualizar guias do AEM](./install-guide/upgrade-xml-documentation.md)
         + [Desinstalar guias do AEM](./install-guide/download-install-unistall-aemg.md)
      ...
      + Trabalhar com as configurações do Editor da Web {#web-editor-configs}
         ...
         + [Personalizar dicionário padrão do AEM](./install-guide/customize-aem-custom-dictionary.md)
         ...
         + [Configurar um conector de fonte de dados](./install-guide/conf-data-source-connector.md)
   ...
   + Cloud Services {#cs-ig}
      ...
      + Implantar e configurar guias de AEM como Cloud Service {#deploy-conf-aemg-cs}
         + [Baixar e instalar](./cs-install-guide/download-install.md)
         + [Implantar módulo de Guias do AEM](./cs-install-guide/download-install-dxml-first-time.md)
         + [Configurar o Dispatcher](./cs-install-guide/download-install-configure-dispatcher.md)
         + [Verificar a instalação dos Guias do AEM](./cs-install-guide/download-install-verify-dxml-installation.md)
         + [Atualizar guias do AEM](./cs-install-guide/download-install-upgrade-dxml.md)
      ...
      + Trabalhar com as configurações do Editor da Web {#web-editor-configs-cs}
         ...
         + [Personalizar dicionário padrão do AEM](./cs-install-guide/customize-aem-custom-dictionary.md)
...
+ Knowledge base {#knowledge-base}
   + Sessão com especialista {#expert-session}
      ...
      + [Relatórios nos Guias do AEM](./knowledge-base/expert-sessions/basic-reports-mar2023.md)
      ...
      + [Estrutura de extensão de guias do AEM](./knowledge-base/expert-sessions/guides-extension-framework-nov2023.md)
