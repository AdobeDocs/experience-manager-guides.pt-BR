      ...
      - Cloud Services {#cloud-release-notes}
         ...
         - Versões de 2026 {#2026-releases}
            ...
            - Versão 2026.03.0 {#2603-release}
               - [Novidades](./release-info/whats-new-2026-03-0.md)
               - [Problemas corrigidos](./release-info/fixed-issues-2026-03-0.md)
               - [Instruções de atualização](./release-info/upgrade-instructions-2026-03-0.md)
   ...
   - Gerenciar conteúdo de aprendizado {#learning-training-content}
      - Guia de introdução {#get-started}
         - Introdução {#intro-lc}
            ...
            - [Notas de versão](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- Instalação e configuração {#install-guide}
   - No local {#on-prem-ig}
      ...
      - Trabalhar com configurações de geração de saída {#output-gen-config}
         ...
         - [Baixar e instalar modelos do AEM Sites](./install-guide/download-install-aem-sites-templates.md)
         - [Mapeamento de componentes do AEM Sites](./install-guide/component-mapping.md)
      ...
      - Indexação personalizada{#custom-indexing}
         - [Implantação de índice personalizado para Localizar e substituir (exibição do Source)](./install-guide/custom-indexing-prem.md)
      - Trabalhar com a replicação de ativos DITA{#dita-assets-replication}
         - [Configurar a replicação de ativos DITA](./install-guide/configure-dita-asset-replication.md)
   ...
   - Cloud Services {#cs-ig}
      ...
      - Implantar e configurar o AEM Guides as Cloud Service {#deploy-conf-aemg-cs}
         ...
         - [Configuração adicional para atualizar o AEM Guides as Cloud Service](./cs-install-guide/additional-config-for-cloud-service.md)
      ...
      - Trabalhar com configurações de geração de saída {#output-gen-config-cs}
         ...
         - [Mapeamento de componentes do AEM Sites](./cs-install-guide/component-mapping.md)
      ...
      - Trabalhar com a replicação de ativos DITA {#dita-assets-replication-cs}
         - [Configurar a replicação de ativos DITA](./cs-install-guide/configure-dita-assets-replication.md)
...
- Instalação e configuração {#install-conf-guide}
   ...
   - Migração de conteúdo {#migrate-content-cs}
      ...
      - [Fazer upload de conteúdo DITA existente usando a ferramenta Framemaker e WebDAV (no local)](./install-conf-guide/upload-dita-content.md)
   ...
   - Configurações de geração de saída {#output-gen-config}
      ...
      - Definir configurações de saída do site do AEM {#conf-aem-sites-output}
         ...
         - [Instruções gerais para personalizar modelos existentes de site do AEM](./install-conf-guide/customize-existing-site-template.md)
         - [Personalizar nova saída do site do AEM](./install-conf-guide/customize-aem-site-output.md)
