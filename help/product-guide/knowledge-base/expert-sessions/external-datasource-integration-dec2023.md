...
- Demonstração completa de trabalho da integração dos guias do AEM
   - atualizar as notas de versão no site e no PDF conforme as alterações disponíveis na JIRA
