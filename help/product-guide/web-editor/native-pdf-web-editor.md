...
Para obter mais informações sobre como gerar um PDF usando o método DITA-OT, consulte [Gerar PDF usando DITA-OT](/help/product-guide/user-guide/generate-output-pdf.md).
...
Para obter mais informações sobre como configurar o FMPS, consulte [Gerar saída de documentos de FrameMaker](/help/product-guide/user-guide/fm-output-generate.md).
