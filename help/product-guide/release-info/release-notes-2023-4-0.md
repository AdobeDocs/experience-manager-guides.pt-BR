...
2. Atualize a propriedade `<dox.version>` no arquivo `/dox/dox.installer/pom.xml` do seu código Git do Cloud Services para 2023.4.249.
3. Confirme as alterações e execute o pipeline dos Serviços em nuvem para atualizar para a versão de abril de 2023 do AEM Guides as a Cloud Service.
...
Esta seção lista a matriz de compatibilidade dos aplicativos de software compatíveis com a versão de abril de 2023 do AEM Guides as a Cloud Service.
...
A Adobe identificou o seguinte problema conhecido para a versão de abril de 2023 do AEM Guides as a Cloud Service.
