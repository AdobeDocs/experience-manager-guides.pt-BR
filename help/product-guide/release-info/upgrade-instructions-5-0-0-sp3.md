---
title: Notas de versão | Instruções de atualização para o Adobe Experience Manager Guides 5.0.0 Service Pack 3
description: Saiba mais sobre a matriz de compatibilidade e como atualizar para a versão 5.0.0 Service Pack 3 do Adobe Experience Manager Guides.
...
# Instruções de atualização do 5.0.0 Service Pack 3 (fevereiro de 2026)

Este artigo aborda as instruções de atualização e a matriz de compatibilidade da versão 5.0.0 Service Pack 3 do Adobe Experience Manager Guides.

Para obter a lista de problemas que foram corrigidos nesta versão, consulte [Problemas corrigidos na versão 5.0.0 do Service Pack 3](../release-info/fixed-issues-5-0-0-sp3.md).

## Matriz de compatibilidade

Esta seção lista a matriz de compatibilidade dos aplicativos de software compatíveis com o Experience Manager Guides 5.0.0 Service Pack 3.
...
| Versão | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | Compatível | 2022 ou superior |
...
## Atualização para a versão 5.0.0 Service Pack 3 do Experience Manager Guides

Você pode atualizar facilmente sua versão atual do Guides para a versão 5.0.0 Service Pack 3. Antes de prosseguir com a atualização para a versão 5.0.0 Service Pack 3 do Experience Manager Guides, você deve considerar os seguintes pontos:

- Se você estiver usando a versão 5.0.0 Service Pack 2, 5.0.0 Service Pack 1 ou 5.0.0, é possível atualizar diretamente para a versão 5.0.0 Service Pack 3.
