...
For more details, view [Configure and use the API JAR from Maven Central repository](https://experienceleague.adobe.com/pt-br/docs/experience-manager-guides/using/api-reference/introduction).
