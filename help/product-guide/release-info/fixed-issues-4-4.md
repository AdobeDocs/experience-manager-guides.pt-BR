...
- No Editor, o recurso de mapa de download não aciona uma notificação pop-up quando está pronto para download. (14626)
- No Editor, o recurso de download de mapa falha ao baixar um mapa com linha de base. (14622)
- Erro de DTD inválido no Experience Manager Guides. (14482)
- O título na guia Editor é truncado após um ponto (.) caractere. (14372)
...
- O Editor lança erros de aplicativo ao adicionar uma nova referência ou tópico usando um esquema especializado na exibição **Layout**. (14094)
...
- Falha ao carregar a coleção **Favoritos** no Editor. (13495)
...
- Os arquivos Zip não são reconhecidos no Editor e você não pode arrastá-los e soltá-los. (12709)
...
- A configuração de mapa de roteiro persiste no Editor mesmo que o usuário não o tenha definido explicitamente nas **Preferências do usuário**. (11551)
- O conteúdo com alguns atributos aplicados não está sendo realçado no modo **Author** ou **Preview**. (11063)
- No Editor, a janela **Referências de chave** é aberta ao inserir a marca `varname`. (10940)
...
- O Editor não tem a capacidade de envolver um elemento dentro dos possíveis elementos principais. (8791)
- O Editor é desinstalado após a reinstalação do Adobe Experience Manager Guides versão 4.3.1. (14519)
...
- A predefinição **Site do AEM** não permite a seleção de um modelo fora da hierarquia `/content` no Editor. (14260)
...
- Opção **ditaval** ausente em predefinições de saída em nível de perfil de pasta criadas por meio da interface do Editor. (11903)
...
- Os arquivos do **Filtro de Linha de Base** não estão funcionando com o Nome de Arquivo no Editor. (13486)
- No Editor, a linha de base mostra o título da versão anterior em vez da versão selecionada do arquivo DITA. (13444)
...
- Os rótulos do arquivo `labels.json` aparecem em ordem aleatória no Editor. (10508)
...
- Problemas de simetria ocorrem nos painéis de revisão lado a lado das versões anterior e atual no Editor. (14156)
