---
title: Notas de versão | Novidades na versão 4.4.0 do Adobe Experience Manager Guides
...
![criar nova linha de base](assets/dynamic-baseline-4-4.png) {width="300"}
...
O Experience Manager agora oferece a capacidade de transferir as propriedades de metadados dos ativos do mapa DITA para a saída do PDF.
Na predefinição de saída nativa do PDF, é possível escolher os metadados que deseja propagar para o processo de publicação do PDF. Você pode selecionar as propriedades personalizadas e padrão.  As propriedades de metadados selecionadas são transferidas para o arquivo do PDF gerado usando o PDF nativo.
