---
title: Notas de versão | Instruções de atualização e problemas corrigidos na versão 2026.03.0 do Adobe Experience Manager Guides
...
# Instruções de atualização para a versão 2026.03.0

Este artigo aborda as instruções de atualização e a matriz de compatibilidade da versão 2026.03.0 do Adobe Experience Manager Guides as a Cloud Service.

Para obter mais informações sobre os novos recursos e aprimoramentos, consulte [Novidades na versão 2026.03.0](whats-new-2026-03-0.md).

Para obter a lista de problemas corrigidos nesta versão, consulte [Problemas corrigidos na versão 2026.03.0](fixed-issues-2026-03-0.md).

## Matriz de compatibilidade

Esta seção aponta a matriz de compatibilidade dos aplicativos de software compatíveis com a versão 2026.03.0 do Experience Manager Guides as a Cloud Service.
...
## Atualização para a versão 2026.03.0
