---
title: Notas de versão | Instruções de atualização e problemas corrigidos no Adobe Experience Manager Guides versão 2025.08.0
description: Saiba mais sobre a matriz de compatibilidade e como atualizar para a versão 2025.08.0 do Adobe Experience Manager Guides as a Cloud Service.
...
# Instruções de atualização para a versão 2025.08.0

Este artigo aborda as instruções de atualização e a matriz de compatibilidade da versão 2025.08.0 do Adobe Experience Manager Guides as a Cloud Service.
...
Esta seção aponta a matriz de compatibilidade dos aplicativos de software compatíveis com a versão 2025.08.0 do Experience Manager Guides as a Cloud Service.

### FRAMEMAKER e FRAMEMAKER PUBLISHING SERVER

| Versão do Experience Manager Guides as a Cloud | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.08.0 | Não compatível | 2022 ou superior |
...
## Atualização para a versão 2025.08.0
