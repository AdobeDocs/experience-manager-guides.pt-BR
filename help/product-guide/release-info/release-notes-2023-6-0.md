...
Esta nota de versão aborda as instruções de atualização, a matriz de compatibilidade e os problemas corrigidos na versão de junho de 2023 do Adobe Experience Manager Guides (mais tarde referido como *AEM Guides as a Cloud Service*).
...
2. Atualize a propriedade `<dox.version>` no arquivo `/dox/dox.installer/pom.xml` do código Git do Cloud Service para 2023.6.297.
...
Esta seção lista a matriz de compatibilidade dos aplicativos de software compatíveis com a versão de as a Cloud Service de junho de 2023 da AEM Guides.
...
- Post versão da nuvem de fevereiro (2302), todo o conteúdo de tradução mostra Fora de sincronia ou Cópia ausente. (11834)
