---
title: Notas de versão | Instruções de atualização e problemas corrigidos nos Guias da Adobe Experience Manager, versão 2024.06.0
...
Esta seção lista a matriz de compatibilidade para os aplicativos de software compatíveis com a versão 2024.06.0 dos Guias do Experience Manager as a Cloud Service.
...
|---|---|---|
| Experience Manager Guias Componentes Pacote de conteúdo para Cloud Service | dxml-components.all-1.2.2 | aem-site-template-dxml.all-1.0.16 |
...
Na resposta anterior, JSON, a chave `lockNodePath` mantém o caminho para o nó criado no repositório, que aponta para o job enviado. Ele será excluído automaticamente quando o trabalho for concluído. Você pode consultar esse nó para obter o status do job.
