...
>[!NOTE]
>
> A partir da **versão 2026.09.0** do Experience Manager Guides as a Cloud Service, o botão **Marcar como concluído** será renomeado para **Concluir tarefa de revisão**, juntamente com recursos adicionais na Interface de revisão para ajudar os revisores a acompanhar seu progresso de revisão. Para obter mais detalhes, consulte [Marcar tópicos individuais como concluído](review-topics.md#mark-individual-topics-as-done-in-a-review-task). As etapas para concluir uma tarefa de revisão permanecem inalteradas.
