...
| Nome da configuração | Dê um nome descritivo para as configurações do site de AEM que você está criando. Por exemplo, você pode especificar *Saída interna de clientes* ou *saída de usuários finais*. |
