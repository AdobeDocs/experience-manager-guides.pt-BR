...
Depois de iniciar a tarefa de geração de saída para um documento do FrameMaker, o Adobe Experience Manager Guides envia essa tarefa para a fila de geração de saída. Essa fila é atualizada em tempo real, mostrando o status de cada tarefa de geração de saída na fila.

Execute as seguintes etapas para exibir a fila de geração de saída:

1. Na interface do usuário do Assets, navegue até o documento FrameMaker e selecione-o para o qual deseja verificar o status de geração de saída.
