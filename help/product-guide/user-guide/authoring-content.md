---
title: Visão geral da criação
description: Conteúdo de autor no Adobe Experience Manager Guides. Saiba como criar, visualizar, editar, salvar a versão do seu documento e compartilhar para revisões.
...
# Visão geral da criação {#id221EAJ0A047}

O Adobe Experience Manager Guides fornece a plataforma para criar conteúdo usando a interface de usuário fácil de usar. Você pode criar seu conteúdo, pré-visualizá-lo, editá-lo, salvar a versão e compartilhar para revisões.
