---
title: Use variáveis para definir as opções Caminho de destino, Caminho do site, Nome do site ou Nome do arquivo
...
# Use variáveis para definir as opções Caminho de destino, Caminho do site, Nome do site ou Nome do arquivo


Ao gerar saídas no AEM Sites ou em PDFs, você pode usar variáveis para definir as opções Caminho de destino, Caminho do site, Nome do site do AEM ou Nome de arquivo do PDF. É possível usar uma única variável ou uma combinação de variáveis para definir essas opções.
