...
- [No console Mapa](#condition-presets-from-the-map-console)
- [No painel Mapa](#condition-presets-from-the-map-dashboard)


## Predefinições de condição do console de mapa
...
1. Navegue até as **Predefinições de condição** à esquerda. A lista de predefinições de condições definidas para o mapa DITA é exibida.
...
1. Selecione a predefinição de condição para exibir os atributos e as ações.
...
1. Siga qualquer um destes procedimentos para adicionar os atributos:
   ...
   - **Selecione todos** para adicionar todos os atributos e seus valores à predefinição de condição. Por padrão, a ação de um atributo é `Include`.
...
Para qualquer atributo, selecione uma das seguintes ações no menu suspenso Ação ou na barra de ferramentas.
   ...
   Selecione várias linhas de atributo no painel direito e escolha uma ação na barra de ações na parte superior. Por exemplo, você pode selecionar a ação **Excluir** para os atributos selecionados.
...
Depois de criar uma predefinição de condição, ela aparecerá na lista suspensa **Predefinições de condição** das **Predefinições de saída**. Saiba mais sobre como [Publicar saída do PDF](../web-editor/native-pdf-web-editor.md).
...
## Predefinições de condição no painel Mapa
...
1. Selecione a guia **Predefinições de condição** no painel do mapa DITA.
1. Selecione **Criar**.
...
1. Siga qualquer um destes procedimentos para adicionar os atributos:
   - Selecione **Adicionar** a um atributo para a predefinição de condição. Você pode repetir essa etapa para adicionar mais atributos.
   - Selecione **Adicionar tudo** para adicionar todos os atributos à predefinição de condição.
1. \(Opcional\) Se necessário, é possível substituir a ação padrão aplicada aos atributos na Etapa 4. Siga uma das seguintes opções:
   - Selecione vários atributos, escolha uma ação de **Defina a ação para as condições selecionadas como** e selecione **Aplicar**.
...
1. Selecione **Remover** para confirmar a ação.
