...
O novo editor permite criar, formatar e organizar tabelas diretamente no seu conteúdo usando várias ações contextuais. Este é um vídeo curto sobre como trabalhar com os vários recursos de edição de tabela disponíveis no Novo editor.

>[!VIDEO](https://video.tv.adobe.com/v/3491344)

Os seguintes recursos de edição de tabela estão disponíveis no Novo editor:
...
>[!NOTE]
>
> A geração MathML propaga a `output-class` associada às equações MathML, permitindo que o estilo configurado, como fontes, cores, planos de fundo e outras formatações, seja refletido na saída gerada.
