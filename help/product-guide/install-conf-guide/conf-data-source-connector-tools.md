...
As guias a seguir fornecem instruções para configurar um conector com base na configuração do Experience Manager Guides: Cloud Service ou No local.
...
Você pode adicionar ou usar vários recursos com base em URLs diferentes para alguns conectores, como Generic REST Client, Salsify, Akeneo e Microsoft Azure DevOps Boards (ADO). Em seguida, conecte-se com eles para criar trechos de conteúdo ou tópicos usando os geradores para eles.
...
Após configurar a fonte de dados, o conector será listado no **painel Fontes de Dados** do Editor. Em seguida, você pode se conectar à fonte de dados e inserir um trecho de conteúdo em seus tópicos. Para obter mais detalhes, exiba [Inserir um trecho de conteúdo da sua fonte de dados](../user-guide/web-editor-content-snippet.md).
