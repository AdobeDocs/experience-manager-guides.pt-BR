...
* O Experience Manager Guides deve estar na versão UUID. Se você estiver usando uma versão não UUID do Adobe Experience Manager Guides, primeiro migre para UUID usando as etapas em [Migrar conteúdo não DITA](../install-conf-guide/uuid-non-uuid.md).
