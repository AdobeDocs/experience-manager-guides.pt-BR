...
> * Se você estiver usando uma versão lançada antes da 4.6.0 Service Pack 4, será necessário primeiro atualizar para a versão 4.6.0 Service Pack 4. Siga as [instruções de atualização](./upgrade-aemg-latest-version.md) específicas para a versão licenciada do seu produto.
...
Para obter mais detalhes, consulte [limpar versões mais antigas](../install-conf-guide/version-management.md#purge-older-versions-of-dita-files).
...
1. Instale a versão UUID da versão compatível sobre a versão não UUID. Por exemplo, se você estiver usando a compilação não UUID do 4.6.0 Service Pack 4, será necessário instalar o UUID versão 4.6.1 [com.adobe.fmdita.feature-uuid-4.6.1.5886.zip](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Faemdox%2Fother-packages%2Fuuid-migration%2F4-0%2Fcom.adobe.fmdita.feature-uuid-4.6.1.5886.zip) e executar a migração.
