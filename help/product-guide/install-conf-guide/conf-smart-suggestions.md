...
7. [Configurar Sugestões Inteligentes no Perfil de Pasta](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
Para obter detalhes, consulte [Configurar Sugestões Inteligentes no Perfil da Pasta](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring).
