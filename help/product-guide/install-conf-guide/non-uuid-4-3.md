...
> * Se você estiver usando uma versão anterior à 4.3.1, atualize para a versão 4.3.1. Siga as [instruções de atualização](./upgrade-aemg-latest-version.md) específicas para a versão licenciada do seu produto.
...
1. Iniciar `http://<server-name>/libs/fmdita/clientlibs/xmleditor_uuid_upgrade/page.html`.
   ...
   ![Guia de atualização do sistema na migração](assets/migration-system-upgrade-4-3-1.png)
   >[!NOTE]
   >
