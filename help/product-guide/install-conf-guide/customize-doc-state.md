...
1. Clique em **Criar Perfil** e insira os seguintes detalhes:
   ...
   - Especifique os estados do documento nos **Estados permitidos** em **Estados**.

     Os estados padrão do documento são Rascunho, Editar, Em revisão, Aprovado e Concluído.-
...
As guias a seguir fornecem instruções para automatizar a alteração do estado do documento com base na configuração do Experience Manager Guides: Cloud Service ou No local.
...
O AEM Guides fornece fluxo de trabalho para aprovação de documentos, que ajuda a controlar o ciclo de vida do processo de desenvolvimento de documentos.

As guias a seguir fornecem instruções para ativar o fluxo de trabalho de aprovação com base na configuração do Experience Manager Guides: Cloud Service ou No local.
