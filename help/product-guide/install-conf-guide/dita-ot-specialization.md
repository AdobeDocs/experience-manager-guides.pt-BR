...
As guias a seguir fornecem instruções para usar plug-ins DITA-OT personalizados com base na configuração do Experience Manager Guides: Cloud Service ou No local.
...
>[!NOTE]
>
> O Editor do AEM Guides não é compatível com XSDs.

As guias a seguir fornecem instruções para integrar a especialização DITA com base na configuração do Experience Manager Guides: Cloud Service ou No local.
...
>[!NOTE]
>
> É possível exportar o perfil DITA personalizado como um pacote e fazer upload nas outras instâncias do AEM Guides para economizar tempo. Para obter mais informações, consulte [Apêndice](./aemg-appendix.md).
