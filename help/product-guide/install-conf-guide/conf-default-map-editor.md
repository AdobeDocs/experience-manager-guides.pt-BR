...
Para versões anteriores à 4.3 e 2307, o Experience Manager Guides vem com um Editor de mapa básico e um Editor de mapa avançado. O Editor de mapa básico fornece todos os recursos necessários para criar seu arquivo de mapa. O Editor de mapa avançado tem muito mais recursos e está integrado ao Editor. O Editor de mapa avançado permite que os autores criem e editem arquivos de mapa DITA com uma interface fácil de usar.
...
As guias a seguir fornecem instruções para tornar o Editor de mapa avançado como o editor padrão dos arquivos de mapa com base na configuração do Experience Manager Guides: Cloud Service ou no local.
...
Use as instruções fornecidas em [Substituições de configuração](download-install-config-override.md#) para criar o arquivo de configuração. No arquivo de configuração, forneça os seguintes detalhes \(propriedade\) para ativar o Editor de mapa básico:
