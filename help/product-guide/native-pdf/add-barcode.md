...
É possível exibir o código de barras ao gerar o PDF de saída usando o modelo, que inclui o layout da página. Depois de executar as etapas anteriores, é possível gerar a saída do PDF com um código de barras.

A captura de tela a seguir exibe um exemplo de código de barras em uma saída do PDF.
...
Para criar um código de barras para um número ISBN, adicione um número ISBN. Em seguida, use o número do ISBN para gerar o código de barras.
...
| ---| --- | --- |
| Código QR | qrcode | A simbologia do código de barras QR de acordo com ISO/IEC 18004:2015. |
| Código 128 | code128 | A simbologia do código de barras 128 conforme definido na ISO/IEC 15417:2007. |
...
| Código 3 de 9 | code39 | O código 3 de 9 código de barras de acordo com ISO/IEC 16388:2007. |
| MSI Plessey | msiplessey |                            |
| Código do canal | channelcode | Código do canal de acordo com ANSI/AIM BC12-1998. |
| Codabar | codabar | Simbologia de código de barras de codabar de acordo com BS EN 798:1996. |
...
| UPC-A | upc-a | Simbologia do código de barras UPC de acordo com BS EN 797:1996. |
| UPC-E | upc-e | Simbologia do código de barras UPC de acordo com BS EN 797:1996. |
| Complemento Ean/UPC | complemento | Simbologia de código de barras de complemento EAN/UPC de acordo com BS EN 797:1996. |
...
| GS1 Databar Limited | limitado à barra de dados | GS1 DataBar Limitada de acordo com ISO/IEC 24724:2011. |
...
| Código asteca | aztec-code | Simbologia do código de barras asteca de acordo com ISO/IEC 24778:2008. |
| DataMatrix | matriz de dados | Matriz de dados ECC 200 código de barras de acordo com ISO/IEC 16022:2006. |
| Código um | code-one |                            |
