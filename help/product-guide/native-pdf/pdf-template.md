...
1. Selecionar **Modelos** ![ícone de modelos](./assets/template.svg) no painel esquerdo.

   <img src="assets/create-pdf-template.png" alt="Criar modelo de PDF" width="400">

1. No **Modelos** selecione a **+** ícone ao lado de **Modelos** e escolha **Modelo PDF**.
1. No **Novo Modelo de PDF** , selecione um modelo de fábrica que deseja usar como base para criar o modelo personalizado. Você também pode usar a caixa de pesquisa para procurar um template.
