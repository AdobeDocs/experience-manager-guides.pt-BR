...
Você pode atualizar sua versão atual do Experience Manager Guides para a versão 5.1.0 Service Pack 4:
...
>[!TIP]
>
> A atualização para a versão 5.0.0 do Service Pack 4 depende da versão atual do Experience Manager Guides. Se você estiver usando a versão 5.0.x, é possível atualizar diretamente para a versão 5.0.0 Service Pack 4.
...
>[!NOTE]
>
>Se estiver atualizando para o 5.1.0 Service Pack 4, você precisa estar na versão 5.1.0 ou 5.1.x do Experience Manager Guides.
