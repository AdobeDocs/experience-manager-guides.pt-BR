...
>[!TIP]
>
> A atualização para a versão 5.1.0 depende da versão atual do Experience Manager Guides. Se você estiver usando a versão 4.6.3, 4.6.4, 5.0.0 ou 5.0.0 do Service Pack 1, é possível atualizar diretamente para a versão 5.1.0.
